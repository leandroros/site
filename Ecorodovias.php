...
<link href="Ecorodovias.css" rel="stylesheet">
</head>
<body>
...
<h1 id="welcomeHeading1">Cliente Ecorodovias</h1>
</div>
...
<h2 id="welcomeHeading2">Escolha abaixo o Download do Flashsafe DLP com UAC e Sem UAC</h2>
</div>
<a id="welcomeButton1" href="https://deploydlp.s3.sa-east-1.amazonaws.com/ecorodovias/ClientEco1_70_2UAC.exe" rel="nofollow" target="_blank" title="FlashSafe DLP" style="display:inline-block;width:172px;height:38px;z-index:8;">Download DLP 1.70.2</a>
</div>
</div>
</div>
</div>
...
<script src="Ecorodovias.js"></script>
</body>
</html>