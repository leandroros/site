...
<link href="Funchal.css" rel="stylesheet">
</head>
<body>
...
<div class="col-5">
<div id="wb_Image2" style="display:inline-block;width:131px;height:34px;z-index:4;">
...
<h1 id="welcomeHeading1">Cliente Funchal  POC</h1>
</div>
...
<a id="welcomeButton1" href="https://deploydlp.s3.sa-east-1.amazonaws.com/epsoft/ClientDLP_1_57_2.exe" rel="nofollow" target="_blank" title="FlashSafe DLP" style="display:inline-block;width:172px;height:38px;z-index:8;">Download</a>
</div>
</div>
</div>
</div>
...
<div id="wb_infoBlock1Card1" style="display:flex;width:calc(100% - 20px);z-index:9;">
   <div id="infoBlock1Card1-card-body">
      <div id="infoBlock1Card1-card-item0"><a href="./index-original.php"><i class="fa fa-chevron-circle-left"></i></a></div>
