...
div#NOFSecureSite1LYR { position:absolute; top:170px; left:155px; width:184px; height:76px; z-index:2 }
-->
</style>

<script type="text/javascript" src="./tabiban_nof.js">
</script>
</head>
<body>
  <div id="LayoutLYR">
    <div id="NOFSecureSite1LYR"><!-- <img id="NOFSecureSite1" height="76" width="184" src="../Tabiban/icon_securemodule.gif" alt=""> --><img src='../Tabiban/icon_securemodule.gif'></div>
